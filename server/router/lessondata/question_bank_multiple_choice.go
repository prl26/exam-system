...
// InitQuestionBankMultipleChoiceRouter 初始化 QuestionBankMultipleChoice 路由信息
func (s *QuestionBankMultipleChoiceRouter) InitQuestionBankMultipleChoiceRouter(Router *gin.RouterGroup) {
	...
	var questionBank_multiple_choiceApi = v1.ApiGroupApp.LessondataApiGroup.QuestionBankMultipleChoiceApi
	{
