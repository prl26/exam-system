...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.Knowledge true "删除Knowledge"
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.Knowledge true "更新Knowledge"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondata.Knowledge true "用id查询Knowledge"
...
func (knowledgeApi *KnowledgeApi) FindKnowledge(c *gin.Context) {
	...
	if reknowledge, err := knowledgeService.GetKnowledge(knowledge.ID); err != nil {
		...
		response.OkWithData(reknowledge, c)
	}
}
...
// @accept application/json
// @Produce application/json
// @Param data query lessondataReq.KnowledgeSearch true "分页获取Knowledge列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /knowledge/getKnowledgeList [get]
func (knowledgeApi *KnowledgeApi) GetKnowledgeList(c *gin.Context) {
	var pageInfo lessondataReq.KnowledgeSearch
