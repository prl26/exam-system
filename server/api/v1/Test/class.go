...
var classService = service.ServiceGroupApp.TestServiceGroup.ClassService
...
// @Param data body Test.Class true "创建Class"
...
// @accept application/json
// @Produce application/json
// @Param data body Test.Class true "删除Class"
...
// @accept application/json
// @Produce application/json
// @Param data body Test.Class true "更新Class"
...
// @accept application/json
// @Produce application/json
// @Param data query Test.Class true "用id查询Class"
...
// @accept application/json
// @Produce application/json
// @Param data query TestReq.ClassSearch true "分页获取Class列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /class/getClassList [get]
func (classApi *ClassApi) GetClassList(c *gin.Context) {
	var pageInfo TestReq.ClassSearch
