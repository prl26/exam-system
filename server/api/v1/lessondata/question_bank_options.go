...
var questionBank_optionsService = service.ServiceGroupApp.LessondataServiceGroup.QuestionBankOptionsService
...
// @Param data body lessondata.QuestionBankOptions true "创建QuestionBankOptions"
...
func (questionBank_optionsApi *QuestionBankOptionsApi) CreateQuestionBankOptions(c *gin.Context) {
	var questionBank_options lessondata.QuestionBankOptions
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankOptions true "删除QuestionBankOptions"
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankOptions true "更新QuestionBankOptions"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondata.QuestionBankOptions true "用id查询QuestionBankOptions"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondataReq.QuestionBankOptionsSearch true "分页获取QuestionBankOptions列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (questionBank_optionsApi *QuestionBankOptionsApi) GetQuestionBankOptionsList(c *gin.Context) {
	var pageInfo lessondataReq.QuestionBankOptionsSearch
