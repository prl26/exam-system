...
var questionBankProgrammCaseService = service.ServiceGroupApp.LessondataServiceGroup.QuestionBankProgrammCaseService
...
// @Param data body lessondata.QuestionBankProgrammCase true "创建QuestionBankProgrammCase"
...
func (questionBankProgrammCaseApi *QuestionBankProgrammCaseApi) CreateQuestionBankProgrammCase(c *gin.Context) {
	var questionBankProgrammCase lessondata.QuestionBankProgrammCase
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankProgrammCase true "删除QuestionBankProgrammCase"
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankProgrammCase true "更新QuestionBankProgrammCase"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondata.QuestionBankProgrammCase true "用id查询QuestionBankProgrammCase"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondataReq.QuestionBankProgrammCaseSearch true "分页获取QuestionBankProgrammCase列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (questionBankProgrammCaseApi *QuestionBankProgrammCaseApi) GetQuestionBankProgrammCaseList(c *gin.Context) {
	var pageInfo lessondataReq.QuestionBankProgrammCaseSearch
