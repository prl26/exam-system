...
var questionBankKnowledgeMergeService = service.ServiceGroupApp.LessondataServiceGroup.QuestionBankKnowledgeMergeService
...
func (questionBankKnowledgeMergeApi *QuestionBankKnowledgeMergeApi) CreateQuestionBankKnowledgeMerge(c *gin.Context) {
	var questionBankKnowledgeMerge lessondata.QuestionBankKnowledgeMerge
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankKnowledgeMerge true "删除QuestionBankKnowledgeMerge"
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankKnowledgeMerge true "更新QuestionBankKnowledgeMerge"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondata.QuestionBankKnowledgeMerge true "用id查询QuestionBankKnowledgeMerge"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondataReq.QuestionBankKnowledgeMergeSearch true "分页获取QuestionBankKnowledgeMerge列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (questionBankKnowledgeMergeApi *QuestionBankKnowledgeMergeApi) GetQuestionBankKnowledgeMergeList(c *gin.Context) {
	var pageInfo lessondataReq.QuestionBankKnowledgeMergeSearch
