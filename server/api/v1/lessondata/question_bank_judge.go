...
var questionBank_judgeService = service.ServiceGroupApp.LessondataServiceGroup.QuestionBankJudgeService
...
func (questionBank_judgeApi *QuestionBankJudgeApi) CreateQuestionBankJudge(c *gin.Context) {
	var questionBank_judge lessondata.QuestionBankJudge
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankJudge true "删除QuestionBankJudge"
...
// @accept application/json
// @Produce application/json
// @Param data body lessondata.QuestionBankJudge true "更新QuestionBankJudge"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondata.QuestionBankJudge true "用id查询QuestionBankJudge"
...
// @accept application/json
// @Produce application/json
// @Param data query lessondataReq.QuestionBankJudgeSearch true "分页获取QuestionBankJudge列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (questionBank_judgeApi *QuestionBankJudgeApi) GetQuestionBankJudgeList(c *gin.Context) {
	var pageInfo lessondataReq.QuestionBankJudgeSearch
