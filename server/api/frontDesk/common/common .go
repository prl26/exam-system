...
func (commonAPi *CommonApi) StudentLogin(c *gin.Context) {
	...
	if user, err := userService.StudentLogin(u); err != nil {
		...
		//	return
		//}
		commonAPi.StudentTokenNext(c, *user)
	}
	//} else {
...
// 登录以后签发jwt
func (commonAPi *CommonApi) StudentTokenNext(c *gin.Context, user basicdata.Student) {
