...
type PaperQuestionMerge struct {
      ...
      Score  *int `json:"score" form:"score" gorm:"column:score;comment:所占分值;size:32;"`
      QuestionType  *int `json:"questionType" form:"questionType" gorm:"column:question_type;comment:题目类型;size:32;"`
}
